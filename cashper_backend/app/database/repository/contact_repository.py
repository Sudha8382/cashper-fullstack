...
class ContactRepository:
    ...
    def get_faq_collection(self):
        """Get FAQs collection"""
        db = get_database()
        collection = db[self.faq_collection_name]
        self._ensure_indexes()
        return collection
    ...
    def _ensure_indexes(self):
        ...
        try:
            ...
            faq_collection = db[self.faq_collection_name]
            ...
            faq_collection.create_index("isActive")
            faq_collection.create_index("order")
    ...
    def create_faq(self, faq: FAQInDB) -> FAQResponse:
        """Create a new FAQ"""
        collection = self.get_faq_collection()
        faq_dict = faq.dict()
        faq_dict["category"] = faq_dict["category"].value
        
        result = collection.insert_one(faq_dict)
    ...
    def get_faq_by_id(self, faq_id: str) -> Optional[dict]:
        ...
        try:
            collection = self.get_faq_collection()
            faq = collection.find_one({"_id": ObjectId(faq_id)})
            return faq
        except Exception as e:
    ...
    def update_faq(
        ...
        try:
            ...
            if "category" in faq_data:
                faq_data["category"] = faq_data["category"].value if hasattr(faq_data["category"], "value") else faq_data["category"]
    ...
    def update_faq_order(self, faq_id: str, new_order: int) -> bool:
        ...
        try:
            ...
            logger.error(f"Error updating FAQ order: {e}")
            return False
